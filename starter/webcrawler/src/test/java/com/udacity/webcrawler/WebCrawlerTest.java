...
public final class WebCrawlerTest {
  ...
  private static final String IMP_OVERRIDE_CLASS_NAME = "com.udacity.webcrawler.ParallelWebCrawler";
//  private static final String IMP_OVERRIDE_CLASS_NAME = "com.udacity.webcrawler.SequentialWebCrawler";
...
//    String[] names = System.getProperty("crawlerImplementations").split("\\s+");
    String[] names = new String[]{IMP_OVERRIDE_CLASS_NAME};
  ...
  public void testBasicCrawl(Class<?> crawlerClass) {
    CrawlerConfiguration config =
        new CrawlerConfiguration.Builder()
            .setImplementationOverride(IMP_OVERRIDE_CLASS_NAME)
            .setMaxDepth(10)
            .setPopularWordCount(3).setTimeoutSeconds(60)
            .addStartPages(Paths.get(DATA_DIR, "test-page.html").toUri().toString())
            .build();
    Guice.createInjector(new WebCrawlerModule(config), new NoOpProfilerModule())
        .injectMembers(this);
